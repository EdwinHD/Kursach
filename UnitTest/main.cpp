...
SUITE(Server)//Макрос. FIXTURE при одинаковых аргумиентах
{
    TEST_FIXTURE(Cons_fix, NormalTest) {
        ...
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
    ...
    TEST_FIXTURE(Cons_fix, ErrclearFileLogParol) {
        //5 Ошибка чтения из файла с логинами и паролями
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/vector.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/clear.txt";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }
    ...
    TEST_FIXTURE(Cons_fix, ErrLogin) {
        ...
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/vector.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/wronglogin.txt";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }
    ...
    TEST_FIXTURE(Cons_fix, ErrParol) {
        ...
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/vector.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/wrongpasswrd.txt";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }

    TEST_FIXTURE(Cons_fix, ErrPutyFileVectors) {
        //8 Ошибка открытия файла с векторами
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/nety.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/config/vclient.conf";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }

    TEST_FIXTURE(Cons_fix, ErrclearFileVectors){
        //9 Ошибка чтения из файла с векторами
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/clear.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/vclient.conf";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }
    
        TEST_FIXTURE(Cons_fix, ErrPutyFileresult) {
        //10 Ошибка открытия файла для записи суммы
        p->vector_file = "/home/stud/C++Projects/123144/build-Debug/bin/vector.txt";
        p->result_file = "/home/stud/C++Projects/123144/build-Debug/bin/142235/result.bin";
        p->autf_file = "/home/stud/C++Projects/123144/build-Debug/bin/config/vclient.conf";
        CHECK_THROW(p->Server("127.0.0.1", "33333"), client_error);
    }
}
